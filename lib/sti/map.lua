...
function Map:setObjectSpriteBatches(layer)
	...
	for _, object in ipairs(layer.objects) do
		if object.gid then
			local horizontalFlip = hasbit(object.gid, bit(32));
			object.gid = clearbit(object.gid, bit(32));

			local verticalFlip = hasbit(object.gid, bit(31));
			object.gid = clearbit(object.gid, bit(31));
			object.gid = clearbit(object.gid, bit(30));
